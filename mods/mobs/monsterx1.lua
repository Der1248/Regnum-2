...
mobs:register_spawn("mobs:dirt_monster", {"default:dirt"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:rainforest_litter_monster", {"default:dirt_with_rainforest_litter"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:green_monster", {"default:dirt_with_grass"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:dry_grass_monster", {"default:dirt_with_dry_grass"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:sand_monster", {"default:sand"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:silver_sand_monster", {"default:silver_sand"}, 20, -1, 1, 3, 31000)
...
mobs:register_spawn("mobs:snow_monster", {"default:snowblock", "default:dirt_with_snow"}, 20, -1, 1, 3, 31000)
mobs:register_spawn("mobs:ice_monster", {"default:ice"}, 20, -1, 1, 3, 31000)