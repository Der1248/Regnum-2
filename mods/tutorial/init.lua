...
minetest.register_node("tutorial:trophy_year6", {
    description = "Six years Regnum 2!!",
	tiles = {
...
minetest.register_node("tutorial:trophy_year5", {
    description = "Five years Regnum 2!!",
	tiles = {
...
minetest.register_globalstep(function(dtime)
	...
	if timer > 0.5 then
		...
		for _,player in ipairs(players) do
			...
			if player_inv:room_for_item("main", "tutorial:trophy_year5") and player_inv:get_stack("year", 6):get_count() == 0 then
